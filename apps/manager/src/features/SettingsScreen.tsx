  ...
  return (
    <>
      ...
      <form className="settings-form" onSubmit={(e) => void submit(e)}>
        {tab === 'profile' && (
          <>
            <h3 style={{ margin: '0 0 4px 0' }}>Store profile</h3>
            <label>
              Store name
              <input
                required
        ...
        {tab === 'general' && (
          <>
            <h3 style={{ margin: '0 0 4px 0' }}>General</h3>
            <div className="form-grid">
              ...
              <label>
                ...
                >
                  Enter the tax rate your shul must charge so receipts and
                  totals are correct.
                </Explain>
                <input
                  type="number"
        ...
        {tab === 'profile' && (
          <>
            <label>
              ...
              >
                Add a short thank-you, return policy, phone number, or other
                note for customers to see on their receipt.
              </Explain>
              <textarea
                rows={3}
        ...
        {tab === 'general' && (
          <>
            <hr
              style={{
                border: 'none',
                borderTop: '1px solid rgba(5,11,8,0.1)',
                margin: '12px 0',
              }}
            />
        ...
        {tab === 'printers' && (
          <>
            ...
            >
              Leave a printer on System default to show the print dialog. A
              named printer prints silently; if that device is missing or
              offline, the dialog opens instead.
            </p>
            {printerError && (
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      receiptPaperWidthMm:
                        Number(e.target.value) === 58 ? 58 : 80,
                    })
                  }
                >
        ...
        {tab === 'general' && (
          <>
            ...
            <label>
              Update feed URL{' '}
              <em>Optional override; blank uses GitHub Releases</em>
              <input
                type="url"
        ...
        {(tab === 'profile' || tab === 'general' || tab === 'printers') && (
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
            ...
            {saved && (
              <span style={{ color: '#1f5e3f', fontWeight: 'bold' }}>
      ...
      {tab === 'processors' && (
        <div className="settings-form">
          <h3 style={{ margin: '0 0 4px 0' }}>Payment processors</h3>
          <Explain
            id="processor-setup"
            ...
            <>
              ...
              <label>
                ...
                <input
                  ...
                  placeholder={
                    processorStatus.keyHint || 'Enter key on this PC'
                  }
                  autoComplete="off"
                />
              </label>
                ...
                <>
                  ...
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setUsaepayTimeout(event.target.value)
                      }
                    />
                  </label>
                  <label className="toggle">
                  ...
                  {readerConnection === 'usb' ? (
                    <label>
                      ...
                      <input
                        value={readerComPort}
                        onChange={(event) =>
                          setReaderComPort(event.target.value)
                        }
                        placeholder="COM3"
                      />
                    </label>
                    ...
                    <>
                      ...
                      <label>
                        ...
                        <input
                          value={readerPort}
                          onChange={(event) =>
                            setReaderPort(event.target.value)
                          }
                        />
                      </label>
                    </>
              ...
              <p style={{ color: '#5f6d65', fontSize: '13px' }}>
      ...
      {tab === 'security' && <CloudAccountSection />}
      ...
      {tab === 'order-emails' && (
        <>
          ...
          >
            Nothing is sent without you reviewing it first. If the internet is
            down the email waits and goes out automatically when you're back
            online.
          </Explain>
          <EmailAccountSection />
        </>
      ...
      {tab === 'backup' && (
        <>
          ...
          >
            ...
            when the internet is unavailable, and changes are sent when it
            returns.
          </Explain>
          <Explain
            id="backups"
      ...
      {tab === 'staff' && (
        <>
          ...
          >
            Owners can always do everything. Cashier permissions let you give
            access to only the work each person needs.
          </Explain>
          <StaffSection />
        </>
      )}
